...
<!-------------------------------------MODAL-------------------------------------------->
        ...
        <form action="" method="">
            <div class="modal-listaDeUsuarios" id="editarUsuario">
                ...
                <div class="botoesModais-listaDeUsuarios">
                    <button class="confirmar-listaDeUsuarios">SALVAR</button>
                    <button class="cancelar-listaDeUsuarios" type="button" onclick="fecharModal('editarUsuario')">CANCELAR</button>
                </div>
            </div>
        </form>
        <form action="" method=""> 
            <div class="modal-listaDeUsuarios" id="visualizarUsuario">
                ...
                <div class="botoesModais-listaDeUsuarios">
                    <button class="confirmar-listaDeUsuarios" type="button" onclick="fecharModal('visualizarUsuario')">FECHAR</button>
                </div>
            </div>
        </form>
        <form action="" method="">
            <div class="modal-listaDeUsuarios" id="deletarUsuario">
                ...
                <div class="botoesModais-listaDeUsuarios">
                    <button class="confirmar-listaDeUsuarios">EXCLUIR</button>
                    <button class="cancelar-listaDeUsuarios" type="button" onclick="fecharModal('deletarUsuario')">CANCELAR</button>
                </div>
            </div>
        </form>
    </section>
